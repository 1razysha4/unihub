...
<meta name="description" content="Post and search college classifieds, Events and Discussions, 10,000+ universities for student housing, summer jobs, roommates, textbooks, college events and discussions.">
        <meta name="keywords" content="college classifieds, collegewaves, collegewaves.com, college waves, student jobs, student housing, summer internships, sublets, textbooks, scholarships, student loans, garage sale, college in US, College in UK, College in Australia">
<script type="text/javascript">
var base_url = '<?php echo base_url();?>';
var site_url = '<?php echo site_url();?>';
</script>
<?php echo $template['metadata']; ?>
<script type='text/javascript' src='<?php echo base_url('assets/public/js/jquery.flexslider-min.js');?>'></script>
  ...
  <div class="search_wrapper">
    <div class="container_24">
      ...
      <?php 
	        ...
	        $state_select=$this->mdl_html->genericlist( $stateOptions, "state_id",array('onchange'=>'getUniversityByState(this.value)','class'=>'validate[required] select'),'value','text',$state_id);
