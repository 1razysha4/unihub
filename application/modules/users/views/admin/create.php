...
<fieldset>
  <div class="widget fluid">
    ...
    <div class="formRow">
      ...
      <div class="grid9">
        <input class="input-xlarge"  name="name" id="first_name" type="text" value="<?php echo $user_details->name;?>" />
      </div>
    </div>
    <div class="formRow">
      <div class="grid3">
    ...
    <div class="formRow">
      ...
      <div class="grid9">
        <input class="input-xlarge" id="cpassword" name="cpassword" type="text" />
      </div>
    </div>
    <div class="formRow">
      <div class="grid3">
