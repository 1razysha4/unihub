...
<table width="40%">
	<tr>
		...
		<td><input type="text" value="" id="groupname" name="groupname"
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="<?php echo $this->lang->line('close'); ?>" name="btn_submit" id="btn_close_group" class="button" onclick="closeform();" />
		</td>
	</tr>
</table>
</form>
