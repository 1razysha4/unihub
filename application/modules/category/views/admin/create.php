...
echo form_open(site_url($this->uri->uri_string()),' enctype="multipart/form-data" class="main"');?>
<fieldset>
  <div class="widget fluid">
    <div class="formRow">
      ...
      <div class="grid9">
        <input class="input-xlarge"  name="category_name" id="category_name" type="text" value="<?php echo $category->category_name;?>" />
      </div>
    </div>
    <div class="formRow">
      <div class="grid3">
    ...
    <div class="grid6">
      ...
      <input type="button" class="buttonS bRed" onclick="javascript:window.location='<?php echo base_url();?>admin/category';" value="<?php echo $this->lang->line('cancel');?>"/>
    </div>
