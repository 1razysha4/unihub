...
class Mdl_Content extends MY_Model{
    ...
    function getPostsByUniversity($page,$university_id,$post_type='',$category_id = 0){
        ...
        $this->db->select('SQL_CALC_FOUND_ROWS c.content_id,c.content_name,c.content_date,c.content_type,ct.category_name,c.content_long_desc,u.username AS posted_by,c.content_created_ts,c.content_image,c.content_page_views,cm.total_comments',false);
        $this->db->from($this->table_name.' AS c');
        ...
        $this->db->join('(
						...
						) AS cm', 'cm.comment_resource_id=c.content_id AND comment_resource_type="content"');
